...
if (needCLodop()) {
    ...
    // oscript.src ="/lib/CLodopfuncs.js?priority=1";
...
function getLodop(oOBJECT,oEMBED){
    ...
    try{
        ...
        if (needCLodop()) {
            try{ LODOP=getCLodop();} catch(err) {alert(err.message)};
		...
		if (window.location.hostname == 'uat.mmchong.com'){
			LODOP.SET_LICENSES("","F91287E405E4B8C6FFC4065F74838B56","C94CEE276DB2187AE6B65D56B3FC2848","");
		} else if (window.location.hostname == 'wms.mmchong.com'){
			LODOP.SET_LICENSES("","F91287E405E4B8C6FFC4065F74838B56","C94CEE276DB2187AE6B65D56B3FC2848","");
		} else {
			LODOP.SET_LICENSES("","705FB23EBC017105C1DBE7FFEE41CD4B","C94CEE276DB2187AE6B65D56B3FC2848","");
		}
        //===========================================================
        return LODOP;
